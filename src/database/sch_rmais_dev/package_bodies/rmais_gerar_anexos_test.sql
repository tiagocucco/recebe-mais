create or replace package body rmais_gerar_anexos_test as
    --
...
------LuzConPDF' || l_data);
    ...
    begin
        ...
        --     WHERE  efd_header_id = p_efd_header_id;
            ...
            l_blob_content := rmais_gerar_anexos_test.blob_danf(p_efd_header_id);
            l_mime_type := 'application/pdf';
            /*BEGIN
        SELECT decode (b.model,'67',XXRMAIS_UTIL_V2_PKG.process_cteos_link(a.source_doc_decr),TO_CLOB(a.source_doc_decr)),
               a.eletronic_invoice_key || '.pdf',
                'application/pdf',
                b.model
          INTO l_clob_content,
...
-- sqlcl_snapshot {"hash":"df377227bcf006a75282c0a31a84c09d1352ec66","type":"PACKAGE_BODY","name":"RMAIS_GERAR_ANEXOS_TEST","schemaName":"SCH_RMAIS_DEV","sxml":""}
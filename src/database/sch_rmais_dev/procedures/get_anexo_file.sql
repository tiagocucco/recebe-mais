create or replace procedure get_anexo_file (
    p_type          in varchar2,
...
-- sqlcl_snapshot {"hash":"9bee1ef542231bda3fa790825202a9106ff86d2d","type":"PROCEDURE","name":"GET_ANEXO_FILE","schemaName":"SCH_RMAIS_DEV","sxml":""}
create or replace package rmais_util_pkg_poc as
  --
    g_test varchar2(30);
  --
    g_log clob;
...
-- sqlcl_snapshot {"hash":"e91ba63f9de474b074dae853b0dbb4aa1a1885ad","type":"PACKAGE_SPEC","name":"RMAIS_UTIL_PKG_POC","schemaName":"SCH_RMAIS_DEV","sxml":""}
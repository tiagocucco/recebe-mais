create or replace package rmais_process_pkg as
  --
...
--PROCEDURE insert_ship(p_ship IN OUT NOCOPY rmais_efd_shipments%ROWTYPE);
  ...
  --
    ...
    --
    procedure integrar_anexo_devolucao;
    --
...
-- sqlcl_snapshot {"hash":"80795f57cb74355211de24f2e9adfb3bea2fcfa1","type":"PACKAGE_SPEC","name":"RMAIS_PROCESS_PKG","schemaName":"SCH_RMAIS_DEV","sxml":""}
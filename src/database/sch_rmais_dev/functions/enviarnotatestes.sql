create or replace function enviarnotatestes (
...
begin
    ...
    exception
        when others then
            vurl := 'https://apex.hdi.uat.a7on.ai/ords/XEPDB1/rmais/rmais/nota_digitada';
            select
                body
            into cbbody
            from
...
-- sqlcl_snapshot {"hash":"206c639e4f2d72da1cab293b69c8e9c7502b4e9d","type":"FUNCTION","name":"ENVIARNOTATESTES","schemaName":"SCH_RMAIS_DEV","sxml":""}
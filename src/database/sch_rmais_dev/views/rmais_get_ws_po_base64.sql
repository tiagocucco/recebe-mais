create or replace force editionable view rmais_get_ws_po_base64 (
    transaction_id,
    cnpj,
    receiver,
    total_po,
...
--
    ...
    from
        (
            ...
            from
                base p,
                json_table ( xxrmais_util_pkg.base64decode(p.clob_info), '$'
                        columns (
                            nested path '$.HEADER[*]'
                                columns (
...
-- sqlcl_snapshot {"hash":"00fb31723de0ed88c033ecfde17bf2c6a8b20c89","type":"VIEW","name":"RMAIS_GET_WS_PO_BASE64","schemaName":"SCH_RMAIS_DEV","sxml":""}